...
const Accordion = ({props, getData,srNo,serviceName, subcategory_name,category_name,duration,item}) => {
  ...
  return (
    <>
      <View style={{ flexDirection: 'row', borderWidth: 0, justifyContent: 'space-between' }}>
        ...
        <Text style={{fontWeight:800,color:'#961702'}}>{srNo}</Text>
        <Text style={{fontWeight:800,color:'#961702'}}>{serviceName}</Text>
